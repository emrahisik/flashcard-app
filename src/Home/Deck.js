...
/*
"Deck" component renders each deck as a card. "deleteHandler" helper function 
invokes deleteDeck function to make delete request to API for the current deck.
"setDlt" controls the deletion state.
*/
