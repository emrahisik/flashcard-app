...
/*
DeckOperation comp conditionally renders for either the Create Deck page 
or the Edit Deck page. "deck" prop is set as an object with keys 
with empty string values for the Create Deck page.
*/


const DeckOperation = ({deck={name:"", description:""}, isNew, setDeck }) => {
      ...
      <div>
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb w-50">
            ...
            {(!isNew) ? (<li className="breadcrumb-item" key="2">
        ...
        <form onSubmit={submitHandler}>
          ...
          <div className="form-group w-50">
            ...
            ></textarea>            
            <button type="reset" onClick={() => isNew ? history.push("/") : history.push(`/decks/${deck.id}`)} className="btn btn-secondary mt-3 mx-3" >Cancel</button>
